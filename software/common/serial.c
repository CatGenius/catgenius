...
#define BUFFER_SPARE		4	/* Minumum number of free positions before issuing Xoff */
...
void serial_rx_isr(void)
{
	...
	// TBD: In case of overflow - don't dequeue last char, just dump new chars
