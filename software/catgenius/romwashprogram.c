...
const struct command	drain_dry[] = {
	{CMD_PUMP,	1},		/* Wash + 29 */
	{CMD_BOWL,	BOWL_CCW},
	{CMD_WAITTIME,	65535},
...
const struct command	cleanupprogram[] = {
	...
	{CMD_WAITTIME,	932},
	{CMD_ARM,	ARM_STOP},
	{CMD_SKIPIFDRY, 1},		/* Skip to surfacing for dry program */
	/* Drain the bowl */
	{CMD_CALL,	(unsigned int)drain_dry},
	/* Surface the granules */
	{CMD_CALL,	(unsigned int)surface},
	{CMD_BOWL,	BOWL_STOP},
#endif /* SIMULATION */
	{CMD_END,	0}
};
...
const struct command	washprogram[] = {
	...
	{CMD_SKIPIFDRY, 53},		/* Skip to surfacing for dry program */
